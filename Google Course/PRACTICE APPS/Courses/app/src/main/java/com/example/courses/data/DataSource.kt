...
object DataSource {
    val topics = listOf(
        ...
        Topic(R.drawable.automotive, R.string.automotive, 30),
        Topic(R.drawable.biology, R.string.biology, 90),
        ...
        Topic(R.drawable.ecology, R.string.ecology, 28),
        Topic(R.drawable.engineering, R.string.engineering, 67),
        Topic(R.drawable.fashion, R.string.fashion, 92),
        Topic(R.drawable.finance, R.string.finance, 100),
        Topic(R.drawable.film, R.string.film, 165),
        Topic(R.drawable.gaming, R.string.gaming, 37),
        Topic(R.drawable.geology, R.string.geology, 290),
        Topic(R.drawable.drawing, R.string.drawing, 326),
        Topic(R.drawable.history, R.string.history, 189),
        Topic(R.drawable.journalism, R.string.journalism, 96),
        Topic(R.drawable.law, R.string.law, 58),
        ...
        Topic(R.drawable.physics, R.string.physics, 41),
